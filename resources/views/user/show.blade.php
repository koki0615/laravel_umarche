        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <div class="flex justify-around items-center">
                                ...
                                <form method="post" action="{{ route('user.cart.add') }}">
                                  ...
                                  <div class="flex items-center">
                                    ...
                                    <div class="relative">
                                      <select name="quantity" class="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-red-500 text-base pl-3 pr-10">
                                  ...
                                  <button class="flex text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">カートに入れる</button>
                    ...
                    <div class="mb-4 text-center">
                        <button type="buttton" data-micromodal-trigger="modal-1" href="javascript:;" class="z-55 text-black bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 rounded">ショップの詳細を見る</button>
                    </div>
                </div>
            </div>
        </div>
