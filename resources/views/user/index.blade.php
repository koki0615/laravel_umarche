                  ...
                  <div class="lg:flex lg:justify-around">
                    <div class="lg:flex items-center">
                        ...
                        <div class="flex space-x-2 items-center">
                            ...
                            <div><button class="text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">検索する</button></div>
                        </div>
                    </div>
                    <div class="flex">
                        <div>
                                  ...
                                  <div class="border rounded-md p-2 md:p-4">
                                      <x-thumbnail filename="{{ $product->filename ?? '' }}" type="products" />
                                        <div class="mt-4">
                                            ...
                                            <p class="mt-1">{{ number_format($product->price) }}<span class="text-sm test-gray-700">円(税込)</span></p>
                                        </div>
                                  </div>
                              </a>
                              </div>
